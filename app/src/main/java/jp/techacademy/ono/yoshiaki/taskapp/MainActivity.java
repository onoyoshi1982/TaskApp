package jp.techacademy.ono.yoshiaki.taskapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    public final static String EXTRA_TASK = "jp.techacademy.ono.yoshiaki.taskapp.TASK";
        ...
        View.OnClickListener mSearchButton = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RealmResults<Task> taskRealmResults =
                        mRealm.where(Task.class).
                                equalTo("category", mCategoryEdit.getText().toString()).
                                findAllSorted("date", Sort.DESCENDING);

                //equalTo("category", SearchCategory)
